...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/scripts/browserStorage.ts":[function(require,module,exports) {
"use strict";
...
var browserStorage_1 = require("./scripts/browserStorage");
var storageManager = new browserStorage_1.BrowserStorage('localStorage');
storageManager.setItem("theme", "vulcan");
console.log("Hello, TypeScript");
var result = storageManager.getItem("theme");
console.log(result);
var element = document.getElementById("theme");
if (element && result) {
  element.textContent = result;
}
},{"./scripts/browserStorage":"src/scripts/browserStorage.ts"}],"../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
